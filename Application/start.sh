...
docker run -d --name mysqlsrv1 -e MYSQL_ROOT_PASSWORD=a123456 -e MYSQL_ROOT_HOST=% -p 3306:3306 -v $HOME/init.sql:/docker-entrypoint-initdb.d/init.sql --restart always mysql
